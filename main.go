...
func main() {
	...
	// Use random test words that aren't in wordlist to detect reflective behavior
	testWords := []string{
		"test123xyz", "random456abc", "check789def", 
		"probe111aaa", "scan222bbb", "fuzz333ccc",
		"detect444ddd", "verify555eee", "sample666fff", "unique777ggg",
	}
